 ...
 * All rights reserved.
 *
 * This software is licensed under undeclaredterms that can be found in the
...
int main(void) {
  ...
  // Exemple d'utilisation de CMSIS-DSP
  float32_t input_array[5] = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f};
  float32_t mean_value;

  // Calcul de la moyenne avec CMSIS-DSP
  arm_mean_f32(input_array, 5, &mean_value);

  // La valeur moyenne est maintenant dans mean_value (devrait être 3.0)
